				...
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids mt-sm-0 mt-4">
						...
						<ul>
							...
							<li class="mb-3">
								<a href="contact.html">Liên lạc với chúng tôi</a>
							</li>
							<li class="mb-3">
								<a href="help.html">Cần giúp đỡ</a>
							</li>
							<li class="mb-3">
								<a href="faqs.html">Faqs</a>
							</li>
							<li class="mb-3">
								<a href="terms.html">Điều kiện sử dụng</a>
							</li>
							<li>
								<a href="privacy.html">Các nguyên tắc bảo mật</a>
							</li>
						</ul>
					</div>
					<div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
						<h3 class="text-white font-weight-bold mb-3">Hãy liên lạc với chúng tôi</h3>
						<ul>
							<li class="mb-3">
					...
					<div class="col-md-3 col-sm-6 footer-grids w3l-agileits mt-md-0 mt-4">
						<!-- newsletter -->
						<h3 class="text-white font-weight-bold mb-3">Báo</h3>
						<p class="mb-3">Miễn phí vận chuyển với đơn hàng đầu tiên</p>
