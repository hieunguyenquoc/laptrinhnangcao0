				...
				<div class="col-lg-3 mt-lg-0 mt-4 p-lg-0">
					<div class="side-bar p-sm-4 p-3">
						...
						<div class="left-side border-bottom py-2">
							<h3 class="agileits-sear-head mb-3">Giảm giát</h3>
							<ul>
								<li>
									<input type="checkbox" class="checked">
									<span class="span">5% hoặc nhiều hơn</span>
								</li>
								<li>
									<input type="checkbox" class="checked">
									<span class="span">10% hoặc nhiều hơn</span>
								</li>
								<li>
									<input type="checkbox" class="checked">
									<span class="span">20% hoặc nhiều hơn</span>
								</li>
								<li>
									<input type="checkbox" class="checked">
									<span class="span">30% hoặc nhiều hơn</span>
								</li>
								<li>
									<input type="checkbox" class="checked">
									<span class="span">50% hoặc nhiều hơn</span>
								</li>
								<li>
									<input type="checkbox" class="checked">
									<span class="span">60% hoặc nhiều hơn</span>
								</li>
							</ul>
						</div>
						<!-- //discounts -->
						...
						<!-- delivery -->
						<div class="left-side border-bottom py-2">
							<h3 class="agileits-sear-head mb-3">Thanh toán COD</h3>
							<ul>
								<li>
									<input type="checkbox" class="checked">
									<span class="span">Được phép thanh toán COD</span>
								</li>
							</ul>
						</div>
						<!-- //delivery -->
						<!-- arrivals -->
						<div class="left-side border-bottom py-2">
							<h3 class="agileits-sear-head mb-3">Hàng mới đến</h3>
							<ul>
								<li>
									<input type="checkbox" class="checked">
									<span class="span">30 ngày gần nhất</span>
								</li>
								<li>
									<input type="checkbox" class="checked">
									<span class="span">90 ngày gần nhất</span>
								</li>
							</ul>
						</div>
						<!-- //arrivals -->
